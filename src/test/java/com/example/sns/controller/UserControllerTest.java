...
@SpringBootTest//스프링 부트 사용하기 때문에 사용
@AutoConfigureMockMvc //api 테스트 할때 사용
...
//
//    @Autowired
//    private ObjectMapper objectMapper; //클래스를 넣을 때 사용한다.
//
//    @MockBean //서비스 사용할 때 사용한다.
...
//                .contentType(MediaType.APPLICATION_JSON) //내용 타입
